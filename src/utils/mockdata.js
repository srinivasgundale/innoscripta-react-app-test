...
export const newsCategories = [
  ...
  { key: 'crimeandjustice', name: 'Crime and Justice' },
  { key: 'opinioneditorials', name: 'Opinion and Editorials' },
  { key: 'culture', name: 'Culture' },
  { key: 'arts', name: 'Arts' },
  { key: 'foodanddining', name: 'Food and Dining' },
  ...
  { key: 'socialissues', name: 'Social Issues' },
  { key: 'agriculture', name: 'Agriculture' },
  { key: 'energy', name: 'Energy' },
  { key: 'immigration', name: 'Immigration' },
  { key: 'militaryanddefense', name: 'Military and Defense' },
  { key: 'investigativereporting', name: 'Investigative Reporting' },
  { key: 'localnews', name: 'Local News' },
  { key: 'nationalnews', name: 'National News' },
  { key: 'internationalrelations', name: 'International Relations' },
  { key: 'celebritynews', name: 'Celebrity News' },
  { key: 'music', name: 'Music' },
  { key: 'filmandmovies', name: 'Film and Movies' },
  { key: 'booksandliterature', name: 'Books and Literature' },
  { key: 'theater', name: 'Theater' },
  { key: 'television', name: 'Television' },
  { key: 'healthcare', name: 'Healthcare' },
  { key: 'scienceandinnovation', name: 'Science and Innovation' },
  { key: 'cybersecurity', name: 'Cybersecurity' },
  { key: 'startups', name: 'Startups' },
  { key: 'gadgets', name: 'Gadgets' },
  { key: 'spaceexploration', name: 'Space Exploration' },
  { key: 'archaeology', name: 'Archaeology' },
  { key: 'philanthropy', name: 'Philanthropy' },
